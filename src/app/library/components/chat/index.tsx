...
const ChatComponent = ({
  ...
  const _renderListFooter = useCallback(() => {
    return (
      <View justifyContent={'center'} middle paddingVertical={15}>
  ...
  // render
  return (
    <View block color={'#FFFFFF'}>
      {renderHeader
        ? renderHeader()
        : useHeader === true && (
            <View style={styles.top} direction={'row'}>
              ...
              <View block justifyContent={'center'} paddingHorizontal={10}>
      ...
      />
      <View style={styles.bottom} direction={'row'}>
        <View block style={[styles.wrapInput]}>
          <TextInput
            value={value}
